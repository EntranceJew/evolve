/*-------------------------------------------------------------------------------------------------------------------------
	Set the DarkRP Wallet of a player
-------------------------------------------------------------------------------------------------------------------------*/
...
function PLUGIN:Call( ply, args )
	if ( ply:EV_HasPrivilege( "Wallet" ) ) then
		...
		if ( #players > 0 ) then
			evolve:Notify( evolve.colors.blue, ply:Nick(), evolve.colors.white, " has granted ", evolve.colors.red, evolve:CreatePlayerList( players ), Color(123,178,68,255), " "..GAMEMODE.Config.currency..amount, evolve.colors.white, "." )
		else
